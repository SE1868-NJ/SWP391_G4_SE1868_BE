...
const updateShipper = async (req, res) => {
  try {
    ...
    if (TempDriverLicenseImage !== undefined) {
      updateFields.push('TempDriverLicenseImage = ?');
      queryParams.push(TempDriverLicenseImage);
    }
